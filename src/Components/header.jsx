        ...
        return (
            <HeadBar>
                <h1 className="db-title">
                    <Link to="/">{this.props.appTitle || '随心所想'} </Link>
                </h1>
                <div className="db-tab-list">
                    <ul className="clearFix ul-li-float">
                        <li>
                            <Link to="/movie2" style={{ color: '#2384E8' }}>电影</Link>
                        </li>
                        <li>
                            <Link to="/book2" style={{ color: '#9F7860' }}>图书</Link>
                        </li>
                        <li>
                            <Link to="/broadcast2" style={{ color: '#E4A813' }}>广播</Link>
                        </li>
                        <li>
                            <Link to="/group2" style={{ color: '#2AB8CC' }}>小组</Link>
                        </li>
                        <li>
